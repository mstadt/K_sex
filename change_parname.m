function pnew = change_parname(pname)
    ...
    elseif strcmp(pname, "V_plasma")
        pnew = "V_{plasma}";
    elseif strcmp(pname, "V_interstitial")
        pnew = "V_{inter}";
    ...
    elseif strcmp(pname, "etapsKreab")
        pnew = "\eta_{ps-Kreab}";
    elseif strcmp(pname, "GFR_base")
        pnew =  "\Phi_{GFR}^{base}";
    elseif strcmp(pname, "eta_ptKreab_base")
        pnew = "\eta_{pt-Kreab}^{base}";
    elseif strcmp(pname, "eta_LoHKreab")
        pnew = "\eta_{LoH-Kreab}";
    elseif strcmp(pname, "eta_ptKreab_highK")
        pnew = "\eta_{pt-Kreab}";
    elseif strcmp(pname, "alpha_TGF")
        pnew = "\alpha_{TGF}";
    elseif strcmp(pname, "alpha_al")
        pnew = "\alpha_{al}";
