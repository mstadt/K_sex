function dydt = kreg_eqns(t,y,sex,params,varargin)
...
if sex == 0  % male
    ...
    rho_al = (66.4 + 0.273*(85/69.2)*C_al)./89.6050;
end
% insulin
max_rho = A_insulin;
...
N_als = xi_ksod; % NOTE: K+ equation only depends on xi_ksod, BP equation has others (xi_map, xi_at)
