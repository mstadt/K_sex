...
end_10daysim <- function(IC0, len_meal, MealTimes, Kamt, params) {
...
main_sim10 <- function(params){
    ...
    vals <- end_10daysim(IC0, 30, MealTimes, Kamt, params)

    return(vals)
}

Kplas_10days_MA <- function(X) {
    #print(class(X))
    #print(X)
    #print(X[1,])
    #temp <- X[1, ]
