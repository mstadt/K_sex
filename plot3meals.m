...
f_MealOnly = './MealSim/26-Jan-2024_driverMeal_insulin-1_Kin-0_notes-insonly.mat';
lab1 = 'Meal Only'; % label for figures


% KCl Only simulation results
f_KClOnly = './MealSim/26-Jan-2024_driverMeal_insulin-0_Kin-35_notes-mealonly.mat';
lab2 = 'KCl Only'; % label for figures

% Meal + KCl simulation results
f_MealKCl = './MealSim/26-Jan-2024_driverMeal_insulin-1_Kin-35_notes-mealkcl.mat';
